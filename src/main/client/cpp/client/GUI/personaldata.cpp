...
PersonalData::PersonalData(QWidget *parent) : QWidget(parent)
{
    ...
    name->setStyleSheet("* {font : 'Arial'; qproperty-alignment: AlignLeft; font-size: 12pt;background-color: rgba(0,0,0,0);}");
    ...
    phoneNumber->setStyleSheet("* {font : 'Arial'; qproperty-alignment: AlignLeft; font-size: 12pt;background-color: rgba(0,0,0,0);}");

    email = new QLabel(QString::fromStdString("Email: " + client.getEmail()), this);
    email->setFixedSize(INFO_PANEL_WIDTH, TITLE_HEIGHT / 2);
    email->setStyleSheet("* {font : 'Arial'; qproperty-alignment: AlignLeft; font-size: 12pt;background-color: rgba(0,0,0,0);}");
